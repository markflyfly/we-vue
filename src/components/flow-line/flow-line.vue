<template>
  <div class="weui-wepay-flow__line" :class="{ 'weui-wepay-flow__line_done': type === 'done', 'weui-wepay-flow__line_ing': type === 'process' }">
  ...
  export default {
    ...
    props: {
      type: {
        ...
        default: 'default',
        validator: (val) => {
          return val === 'default' || val === 'process' || val === 'done'
        }
      }
    }
  }
